...
#define BLOCK_ROWS 4
#define BLOCK_COLS 4
#define I(i, j) (i * BLOCK_COLS + j)
#define T(i, j) I(j, i)
#define BLOCK_SIZE (BLOCK_ROWS * BLOCK_COLS)
...
#define BYTE_BITS (sizeof(uint8_t) * 8)

#define BYTE_CLSHIFT(X, AMOUNT) ((X << AMOUNT) | (X >> (BYTE_BITS - AMOUNT)))

// The lookup-tables are marked const so they can be placed in read-only storage instead of RAM
// The numbers below can be computed dynamically trading ROM for RAM -
// This can be useful in (embedded) bootloader applications, where ROM is often limited.
// @see https://github.com/kokke/tiny-AES-c/blob/master/aes.c
